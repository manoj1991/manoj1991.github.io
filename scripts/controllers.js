...
angular.module('a11yTicketApp')
    ...
    .controller('EditCtrl', function ($scope, $rootScope ,$location, $routeParams, $firebase, fbURL, country, genres, Flash) {
        ...
        $scope.wcagSCList = country.wcagSCList;
        $scope.severityList = genres.severityList;
    ...
    .controller('CreateCtrl', function ($scope, $rootScope, Tickets, $location, $routeParams, $firebase, fbURL, country, genres, Flash) {
